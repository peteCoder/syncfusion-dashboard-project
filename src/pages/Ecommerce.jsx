  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        ...
        h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover
        bg-center'>
          {/* Continue from here ! */}
          <div className='flex justify-between flex-col'>
            <div>
              <p className='font-bold text-gray-600'>Earnings</p>
              <p className='text-2xl text-white font-bold'>$63,343.43</p>
            </div>
            <div className='mt-6'>
              <Button
                color="white"
        ...
        <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
          {
            earningData.map(item => (
              ...
              >
                ...
                <p className='text-sm text-gray-400 md-1'>{item.title}</p>
              </div>
            ))
          }
        </div>
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
        <div className='bg-white dark:text-gray-200 
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className="border-color m-4 pr-4">
              <div className="">
                <p>
